...
Future<void> main(List<String> arguments) async {
  ...
  print("Quer começar? 1-Sim 2-Não");
  ...
  while(answer == 1) {
    ...
    if(parsedJson["success"] == true) {
      ...
      print("Final Kills: ${mushPlayer.response?.stats?.bedwars?.finalKills ?? 0}");
      print("Final Deaths: ${mushPlayer.response?.stats?.bedwars?.finalDeaths ?? 0}");
      print("Camas Quebradas: ${mushPlayer.response?.stats?.bedwars?.bedsBroken ?? 0}");
      print("Winstreak: ${mushPlayer.response?.stats?.bedwars?.winstreak ?? 0}");
      print("Level: ${mushPlayer.response?.stats?.bedwars?.level ?? 0}");
